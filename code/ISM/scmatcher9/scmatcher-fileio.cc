  ...
  /*******************************************************************/
{
  ...
  ofstream ofile( qsFileName.ascii() );
  if( !ofile ) {
...
{  
  ...
  list<HoughVote> votelist(m_vActiveVotes.begin(), m_vActiveVotes.end());
  
  m_ismReco.drawSegmentation( votelist,
                              m_vPointsInside, m_fcCue, 
                              imgPFig, imgPGnd, imgSeg, true );
