									...
									bool bSaveResult ) 
{
  ...
  tmp.setColor(colors++, (Qt::black).rgb() );
  ...
  if( bSaveResult ) {
    QString file = QFileDialog::getSaveFileName( "/home/leibe/projects/interestpoints/interestviewer/",
